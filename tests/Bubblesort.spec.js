...
describe('Bubblesort', () => {
  ...
  it('should sort', () => {
    ...
    const actual = new Bubblesort([4, 3, 1, 7, 2, 5, 6, 9, 8]).sort();
  ...
  it('should sort an array with duplicated items', () => {
    ...
    const actual = new Bubblesort([4, 5, 5, 1, 3, 8, 6, 2, 9, 7, 6, 0]).sort();
  ...
  it('should sort an array with negative items', () => {
    ...
    const actual = new Bubblesort([5, -1, 6, -10, 3, 9, 0, 8, -2]).sort();
